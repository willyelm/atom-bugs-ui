  ...
  run: {
    value (message, finish) {
      return new Promise((resolve, reject) => {
        ...
        this.childTask.stdout.on('data', (m) => message(String(m)))
        this.childTask.stderr.on('data', (m) => message(String(m)))
        this.childTask.stdout.on('end', (m) => finish(String(m)))
        this.childTask.stderr.on('end', (m) => finish(String(m)))
